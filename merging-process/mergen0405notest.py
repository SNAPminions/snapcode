...
#maybe write an if-clause which checks the absolute number of snap-ids/entries in the database and create a print output if the input number us lower
...
def instantiateTemplate(filePath):
    concfilePath = filePath + '/mergedTriplets.rdf'
